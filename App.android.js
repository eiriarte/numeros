...
export default class App extends React.Component {
  ...
  async _preloadAssets() {
    await Asset.loadAsync([
      ...
      require('./img/android_dialpad.png'),
      require('./img/android_today.png'),
      require('./img/android_watch.png'),
      require('./img/android_book.png'),
      require('./img/android_check.png'),
      require('./MaterialDialog/img/android_radio_checked.png'),
      require('./MaterialDialog/img/android_radio_unchecked.png'),
